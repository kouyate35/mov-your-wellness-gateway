        ...
        <div className="flex items-end justify-between mb-3 px-1">
          ...
          {selectedProgramId && (
            <button
              ...
              className="flex items-center gap-1.5 pl-3 pr-4 py-1.5 bg-white text-black rounded-full font-semibold text-[13px] hover:bg-white/90 active:scale-95 transition-all animate-fade-in shadow-[0_4px_14px_rgba(255,255,255,0.18)]"
            >
