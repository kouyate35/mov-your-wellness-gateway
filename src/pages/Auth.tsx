      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {mode === "signup" 
              ? "Rejoignez MOV et reprenez le contrôle de votre temps."
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 bg-card border-border text-foreground placeholder:text-muted-foreground/50"
                />
              </div>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 h-12 bg-card border-border text-foreground placeholder:text-muted-foreground/50"
              />
              <button
                type="button"
